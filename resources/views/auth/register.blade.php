          ...
          <div class="row flex-grow">
            <div class="col-lg-4 mx-auto">
              <div class="auth-form-light text-left p-5">
                ...
                <h4>Baru di Giziku?</h4>
                <h6 class="font-weight-light">Daftar sangat mudah. Hanya butuh beberapa langkah saja.</h6>
                <form class="pt-3">
                  <div class="form-group">
                    <input type="text" class="form-control form-control-lg" id="exampleInputUsername1" placeholder="Masukkan Nama Pengguna">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="mt-3">
                    <a class="btn d-grid btn-primary btn-lg font-weight-medium auth-form-btn" href="../../index.html">Daftar</a>
                  </div>
                  <div class="text-center mt-4 font-weight-light"> Sudah punya akun? <a href="/login" class="text-primary">Masuk</a>
                  </div>
                </form>
              </div>
            </div>
